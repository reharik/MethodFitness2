...
//        }
    ...
    public class AdminController : MFController
    {
    }
    ...
    public class AjaxAwareRedirectResult : RedirectResult
    {
        ...
        public override void ExecuteResult(ControllerContext context)
        {
            ...
            {
                string destinationUrl = Microsoft.AspNetCore.Mvc.Routing.UrlHelper.GenerateContentUrl(Url, context.HttpContext);
