...
mf.PortfolioBuilderController  = mf.Controller.extend({
    events:_.extend({
    ...
    initialize:function(){
        ...
        mf.contentLevelControllers["portfolioBuilderController"]=this;
    ...
    loadGrid:function(){
        ...
        $("#landingPage").hide();
        this.el="#masterArea";
        this.views.gridView = new mf.AssetGridView(this.options);
    },

    loadLandingPage:function(){
        $("#gridArea").hide();
        var landingPageOptions = $.extend({},this.options,{el:"#landingPage"});
        this.views.portfolioLandingPage = new mf.PortfolioLandingPageView(landingPageOptions);
    },
    ...
    addEditItem: function(url,assetType){
        ...
        this.views.formView = new mf.PortfolioFormView(formOptions);
    ...
    setupMainForm: function(formOptions){
        ...
        $.each(formOptions.portfolioBuilderData.assetTypes, function(i,asset){
            ...
            that.views[asset+"TokenView"] = new mf.TokenView(tokenOptions);
...
//        $(window).scrollTop($('#headerArea').position().top)
    ...
    addEditAsset:function(name){
        ...
        this.modules[name+"FormModule"] = new mf.AssetFormModule(formOptions);
    ...
    loadPreviewPortfolioDisplay:function(url){
        ...
        this.modules["previewDisplay"] = new mf.AjaxPopupDisplayModule(displayOptions);
    },
    ...
    printSetup:function(){
        ...
        this.views[this.id + "print"] = new mf.AjaxDisplayView(displayOptions);
    ...
    emailPortfolio:function(){
        ...
        this.modules["emailPortfolio"] = new mf.AjaxPopupFormModule(formOptions);
    },
    ...
    setupNewHeadShot:function(){
        ...
        this.views["headShotAddUpdate"] = new mf.AjaxFormView(formOptions);
    ...
    loadHeadShotPopupModule: function(formOptions){
        var popupOptions = {
            id:"headShot",
            el:"#addNewHeadShotDiv",
            buttons: mf.popupButtonBuilder.builder("headShot").standardEditButons(),
            title:formOptions.title
        };
        this.views.headShotPopupView = new mf.PopupView(popupOptions);
    },
