...
mf.HomeController = mf.Controller.extend({
    events:_.extend({
    ...
    userProfileSettings:function(){
        ...
        this.modules["userProfileController"] = new mf.UserProfileController(profileOptions);
    ...
    addressChange: function(){
        $.address.change(function(event) {
            ...
            if(value=="/") {
                ...
                mf.repository.ajaxGet(value,{},function(result){
                    $.each(mf.contentLevelControllers,function(name,value){
                        if(value)
                        value.destroy();
                    });
                    mf.contentLevelControllers = {};
