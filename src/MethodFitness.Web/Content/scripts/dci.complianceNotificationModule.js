...
if (typeof mf.complianceNotification == "undefined") {
            mf.complianceNotification= {};
}

mf.complianceNotificationModule = function(container, options){
    var _container = container;
    var myOptions = $.extend({}, mf.complianceNotificationModuleDefaults, options || {});
    var modules = {};
...
mf.complianceNotificationModuleDefaults = { };
