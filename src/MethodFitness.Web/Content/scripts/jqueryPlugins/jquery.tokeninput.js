    ...
    var input_token = $("<li />")
        .click(function () {
            if (settings.tokenLimit === null || settings.tokenLimit !== token_count) {
                 populate_dropdown(null,settings.local_data);  //show_dropdown_hint();
            }
        })
...
*/
    ...
    this.addToAvailableList= function(item){
        var exists = false;
        $(settings.local_data).each(function(i,existingItem){
    ...
    function insert_token(item) {
        var this_token = $("<li>"+settings.internalTokenMarkup(item)+"</li>")
