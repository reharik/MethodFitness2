...
$.TokenList = function (_input, _viewModel, _settings) {
    var input = _input;
    var viewModel = _viewModel;
    var settings = _settings;
    this.init = function(binding){
    ...
    this.render = function(options){
        ...
        var selected_token_list = $("<ul />")
            ...
            .delegate("li","click",function(){
                ...
                input_box.focus();
                MF.vent.trigger(id+":tokenizer:selectedClick",$li.attr('id'));
        ...
        function add_modelItem_to_selected(item) {
            ...
            settings.beforeTokenAddedFunction(clone);
        ...
        function find_modelItem_for_selected_listItem (token){
            return _.find(settings.viewModel.selectedItems(), function(item,i){
                return $(token).find("p").text().indexOf(item.name())>-1;
            })
        }
